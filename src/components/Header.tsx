        ...
        <div className="flex-1 max-w-md mx-8">
          <div className="relative">
            ...
            <input
              type="search"
              placeholder="작업 검색..."
              className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 pl-10 focus:outline-none focus:ring-0 focus:border-input focus-visible:ring-0 focus-visible:ring-offset-0"
